...
ผู้ใช้สามารถโต้ตอบกับตู้ผ่าน GUI เพื่อเลือกสินค้า, หยิบใส่ตะกร้า, เลือกวิธีชำระเงิน (QR/เงินสด), รับสินค้า และรับเงินทอน นอกจากนี้ยังมี "โหมดแอดมิน" ที่ซ่อนไว้สำหรับจัดการสต็อกและเก็บเงินอีกด้วย

## ✨ ฟีเจอร์หลัก (Features)

  * **GUI:** ใช้หน้าตาแบบกราฟิก (`VendingUI.java`) พร้อม UX/UI ที่สวยงาม
  ...
  * **ระบบสมาชิก (Member System):**
      ...
      * **Data Persistence:** โหลดและบันทึกข้อมูลสมาชิกไปยังไฟล์ `member_data.txt` โดยอัตโนมัติ
